...
moules_dt = pd.read_csv(labelfile, delimiter = ';', header = 0, names = ['Y_moule','X_moule','Latitude','Longitude','nbrs_moules','Classe'], usecols=['X_moule','Y_moule','nbrs_moules','Classe'])
